          ...
          <aside className="rounded-[28px] border border-emerald-100/60 bg-white/85 p-6 shadow-lg">
            ...
            <div className="mt-6 space-y-4">
              <div className="space-y-2">
                <div className="h-3 w-24 animate-pulse rounded bg-red-200/50" />
                <div className="flex flex-wrap gap-2">
                  <div className="h-7 w-20 animate-pulse rounded-full bg-red-100/50" />
                  <div className="h-7 w-20 animate-pulse rounded-full bg-red-100/50" />
                </div>
              </div>
              <div className="space-y-2">
                <div className="h-3 w-28 animate-pulse rounded bg-green-200/50" />
                <div className="flex flex-wrap gap-2">
                  <div className="h-7 w-20 animate-pulse rounded-full bg-green-100/50" />
                  <div className="h-7 w-20 animate-pulse rounded-full bg-green-100/50" />
                </div>
              </div>
            </div>
